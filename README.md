...
## Showcase: the first film, rendered end to end

A real film rendered end to end on Vivijure, an unedited render straight off the pipeline. (The
scored and narrated films on the cloud i2v backends are being re-rendered after an aspect-ratio
fix and will return to the showcase shortly.)

### NEON HALFLIFE -- silent (own-GPU i2v)
