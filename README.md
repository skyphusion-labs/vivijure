...
### The talking-character showcase -- talking, lip-sync (own-GPU Wan i2v)

[![The talking-character Vivijure showcase, a character lip-synced to its own dialogue, click to play the MP4](https://assets.skyphusion.net/vivijure/showcase/talking-character.jpg)](https://assets.skyphusion.net/vivijure/showcase/talking-character.mp4)

*[The talking-character showcase](https://assets.skyphusion.net/vivijure/showcase/talking-character.mp4): two shots, about two and a half seconds. A talking character lip-synced to its own dialogue (per-shot dialogue TTS, then the MuseTalk lip-sync module over an interpolated clip). Motion on a self-hosted GPU (the `own-gpu` Wan I2V backend). Click the frame above to play, or [download the MP4](https://assets.skyphusion.net/vivijure/showcase/talking-character.mp4).*
...
- **Give characters a voice** -- generate per-shot dialogue and lip-sync it with MuseTalk, as
  opt-in finish modules over the same motion path.
