...
## Showcase: three films, three audio modes, three backends

Three real films rendered end to end on Vivijure, unedited renders straight off the pipeline.
Silent picture, scored with a generated music bed, and narrated with TTS -- on three different
motion backends (own-GPU Wan, Seedance cloud, Kling cloud).
