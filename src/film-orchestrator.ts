...
import type { KeyframeInput, KeyframeOutput, FinishInput, FinishOutput, ConfigSchema, NotifyInput, NotifyOutput, DialogueLine, DialogueInput, DialogueOutput, SpeechInput, SpeechOutput } from "./modules/types";
import {
...
export interface FilmJob {
  ...
  phase: "keyframe" | "clips" | "dialogue" | "speech" | "finish" | "assemble" | "mux" | "done" | "failed";
